     ...
     <div class="cuntainer">
        <div class="wolf">
            ...
            <div class="footer-ol">
                <h4>online shop</h4>
                <ul>
                    <li><a href="shop.php?cat_id=7">Saloon Products</a></li><br><br>
                    <li><a href="shop.php?cat_id=8">Parlor Prtoducts</a></li><br><br>
                    <li><a href="shop.php?cat_id=9">Garments</a></li><br><br>
                    <li><a href="shop.php?cat_id=10">Daily use</a></li><br><br>
                    <li><a href="shop.php?cat_id=11">Others</a></li><br><br>
                </ul>
            </div>
            <div class="footer-ol">
                <h4>follow us</h4>
            ...
            <p class="credit">Copyright &copy; <span>2015-2021</span> | all rights reserved. | <span>Designed With By Your Company Name</span></p>
        </div>
     </div>
  </footer>
